...
<form method="POST" action="<?= site_url('C_perawatan/edit/'.$kategori->id_perawatan) ?>" enctype="multipart/form-data">
<div class="box-body">
    ...
    <div class="form-group">
       <label>Nama Aset</label>
          <select class="form-control" name="nama_aset" id="nama_aset">
  ...
  <!--   <div class="form-group">
        ...
        <input type="text" name="no_identifikasi" class="form-control" placeholder="No Identifikasi" value="<?php echo $kategori->no_identifikasi ?>">
    </div> -->
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="keterangan" class="form-control" placeholder="Keterangan" value="<?php echo $kategori->keterangan ?>">
    </div>

    <div class="form-group">
        <label>Tanggal Diperbaiki</label>
        <input type="date" name="tgl_diperbaiki" class="form-control" placeholder="Keterangan" value="<?php echo $kategori->tgl_diperbaiki ?>">
    </div>

    <div class="form-group">
        <label>Tanggal Selesai</label>
        <input type="date" name="tgl_selesai" class="form-control" placeholder="Tanggal Selesai" value="<?php echo $kategori->tgl_selesai ?>">
    </div>
     <div class="form-group">
...
<script src="<?php echo base_url('assets/jquery-1.10.2.min.js') ?>"></script>
        ...
        <script>
            $("#nama_aset").chained("#nama_ruangan"); // disini kita hubungkan kota dengan provinsi
       
             $("#no_identifikasi").chained("#nama_aset");
        </script>
</div>
