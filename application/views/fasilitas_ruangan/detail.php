                    ...
                    <tbody>
                     <?php $i=1; while ($i <= $kategoriku->total){  ?>
                      ...
                      <td><?php echo $kategoriku->jumlah ?></td>
						...
						<td><a href='<?php echo base_url('fasilitas_ruangan/detail_lengkap/'.$kategoriku->id_fasilitas_ruangan) ?>'><i class='fa fa-eye' style='margin-right:5px;color:black;'></i> </a></td>
